...
import com.example.chatroom.config.jwt.filter.JwtAuthenticationFilter;
import com.example.chatroom.config.jwt.handler.JwtLoginFailHandler;
...
public class JwtLoginConfigurer<T extends JwtLoginConfigurer<T, B>, B extends HttpSecurityBuilder<B>>
    ...
    public void configure(B http){
        ...
        authFilter.setAuthenticationFailureHandler(new JwtLoginFailHandler());
